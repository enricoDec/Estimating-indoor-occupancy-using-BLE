...
- [Deployment](#deployment)
  ...
  - [Mosquitto Stack](#mosquitto-stack)
  - [InfluxDB Stack](#influxdb-stack)
  - [Node-Red Stack](#node-red-stack)
    - [To change the password:](#to-change-the-password)
    - [Install required Modules](#install-required-modules)
      - [(Option 1): Using cmd](#option-1-using-cmd)
      - [(Option 2): Using the Node-Red UI](#option-2-using-the-node-red-ui)
    - [Import the `nodeRed.json` file:](#import-the-noderedjson-file)
    - [Test the setup](#test-the-setup)
  - [Setup ESP32](#setup-esp32)
    - [1. Install esptool (needed to flash the board with microPython)](#1-install-esptool-needed-to-flash-the-board-with-micropython)
    ...
    - [4. Upload the project to the board](#4-upload-the-project-to-the-board)
      - [Setup the project using Visual Studio Code](#setup-the-project-using-visual-studio-code)
      - [Setup the project using Thonny](#setup-the-project-using-thonny)
  - [Working with the project and throubleshooting](#working-with-the-project-and-throubleshooting)
    - [Get code completion for the project (Option 1)](#get-code-completion-for-the-project-option-1)
    - [Get code completion for the project by stubbing (Option 2)](#get-code-completion-for-the-project-by-stubbing-option-2)
    - [Get code completion for the project by stubbing yourself (Option 3) (Good luck)](#get-code-completion-for-the-project-by-stubbing-yourself-option-3-good-luck)
